...
public class EntregaContract {
    ...
    public static class COLUMN implements BaseColumns {
        ...
        public static final String ID_REPARTIDOR = "IdRepartidor";
    }
}
