...
public class DireccionContract {
    ...
    private DireccionContract() {}

    // Definicion de las columnas de la tabla
    public static final String SQL_CREATE_ENTRIES = new QueryBuilder()
            .setTable(DireccionContract.TABLE_NAME)
            .addField(COLUMN.ID, FieldType.INTEGER, true, true, true)
            .addField(COLUMN.NOMBRE_DISTRITO, FieldType.TEXT, true)
            .addField(COLUMN.NOMBRE_CANTON, FieldType.TEXT, true)
            .addField(COLUMN.NOMBRE_PROVINCIA, FieldType.TEXT, true)
            .addField(COLUMN.DIRECCION_EXACTA, FieldType.TEXT, true)
            .finish();

    // Instruccion SQL para eliminar la tabla
    public static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + DireccionContract.TABLE_NAME + ";";

    // Clase interna que define el contenido de la tabla
    public static class COLUMN implements BaseColumns {
        public static final String ID = "Id";
        public static final String NOMBRE_DISTRITO = "Distrito";
        public static final String NOMBRE_CANTON = "Canton";
        public static final String NOMBRE_PROVINCIA = "Provincia";
        public static final String DIRECCION_EXACTA = "DireccionExacta";
    }
