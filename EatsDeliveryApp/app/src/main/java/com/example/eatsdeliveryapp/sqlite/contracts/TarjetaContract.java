...
public class TarjetaContract {
    ...
    private TarjetaContract() {}

    // Definicion de las columnas de la tabla
    public static final String SQL_CREATE_ENTRIES = new QueryBuilder()
            .setTable(TarjetaContract.TABLE_NAME)
            .addField(COLUMN.ID, FieldType.INTEGER, true, true, true)
            .addField(COLUMN.ID_CLIENTE, FieldType.INTEGER, true)
            .addField(COLUMN.NUMERO, FieldType.INTEGER, true)
            .addField(COLUMN.NOMBRE_TITULAR, FieldType.TEXT, true)
            .addField(COLUMN.FECHA_VENCIMIENTO, FieldType.TEXT, true)
            .addField(COLUMN.CODIGO_SEGURIDAD, FieldType.INTEGER, true)
    ...
    public static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + TarjetaContract.TABLE_NAME + ";";
    ...
    public static class COLUMN implements BaseColumns {
        ...
        public static final String CODIGO_SEGURIDAD = "CodigoSeguridad";
    }
}
