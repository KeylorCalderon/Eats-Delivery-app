...
public class EstadoPedidoContract {
    ...
    public static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + EstadoPedidoContract.TABLE_NAME + ";";
