...
public class ListaAdapterPedidosCliente extends BaseAdapter {
    ...
    public ListaAdapterPedidosCliente(Context context, List<Pedido> pedidos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap icon = BitmapFactory.decodeResource(this.context.getResources(),
                R.drawable.cancelarpedidosblanco);
