...
public class CarritoContract {
    ...
    public static final String SQL_DELETE_ENTRIES =
            "DROP TABLE IF EXISTS " + CarritoContract.TABLE_NAME + ";";
